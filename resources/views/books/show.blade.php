    ...
    <div class="container py-5">
        ...
        <nav aria-label="breadcrumb" class="mb-4">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="{{ route('books.index') }}" class="text-decoration-none">Katalog
                        Buku</a></li>
        ...
        <div class="row g-4">
                    ...
                    <div class="position-relative book-cover-container">
                        ...
                        <div class="position-absolute top-0 end-0 m-3">
                            <span
                                ...
                                <i
                                    class="fas {{ $book->availableStock > 0 ? 'fa-check-circle' : 'fa-times-circle' }} me-1"></i>{{ $book->availableStock > 0 ? 'Tersedia' : 'Dipinjam' }}
                            </span>
                        </div>
                    </div>
            ...
            <div class="col-md-8">
                ...
                <ul class="nav nav-tabs mb-4" id="bookDetailTab" role="tablist">
                    <li class="nav-item" role="presentation">
                        <button class="nav-link active" id="details-tab" data-bs-toggle="tab"
                            ...
                            aria-controls="details-tab-pane" aria-selected="true">Detail</button>
                    </li>
                    <li class="nav-item" role="presentation">
                        <button class="nav-link" id="description-tab" data-bs-toggle="tab"
                            data-bs-target="#description-tab-pane" type="button" role="tab"
                            aria-controls="description-tab-pane" aria-selected="false">Deskripsi</button>
                    </li>
                    <li class="nav-item" role="presentation">
                        <button class="nav-link" id="similar-tab" data-bs-toggle="tab" data-bs-target="#similar-tab-pane"
                            type="button" role="tab" aria-controls="similar-tab-pane" aria-selected="false">Buku
                            Serupa</button>
                    </li>
                    <li class="nav-item" role="presentation">
                        <button class="nav-link" id="rules-tab" data-bs-toggle="tab" data-bs-target="#rules-tab-pane"
                            type="button" role="tab" aria-controls="rules-tab-pane" aria-selected="false">Aturan
                            Peminjaman</button>
                    </li>
                </ul>
                ...
                <div class="tab-content" id="bookDetailTabContent">
                    ...
                    <!-- Tab Buku Serupa -->
                    <div class="tab-pane fade" id="similar-tab-pane" role="tabpanel" aria-labelledby="similar-tab"
                        tabindex="0">
                        <div class="card border-0 shadow-sm mb-4">
                            <div class="card-body p-4">
                                                    ...
                                                    <div class="row g-0 h-100">
                                                        <div class="col-4">
                                                            <img src="{{ $similar->cover_image ? asset('storage/' . $similar->cover_image) : asset('images/default-book-cover.png') }}"
                                                                ...
                                                                style="object-fit: cover;" alt="{{ $similar->title }}">
                                                        </div>
                                                        <div class="col-8">
                                                            <div class="card-body p-3">
                                                                <span
                                                                    class="badge bg-primary bg-opacity-10 text-primary mb-2">{{ $similar->category }}</span>
                    ...
                    <div class="tab-pane fade" id="rules-tab-pane" role="tabpanel" aria-labelledby="rules-tab"
                        tabindex="0">
                        <div class="card border-0 shadow-sm mb-4">
                            <div class="card-body p-4">
                                    ...
                                    <div class="col-md-6">
                                        <div class="d-flex">
                                            ...
                                            <div class="flex-grow-1 ms-3">
                                                ...
                                                <p class="text-muted small mb-0">Maksimal durasi peminjaman adalah 7 hari
                                                    kalender. Untuk guru, dapat diperpanjang hingga 14 hari.</p>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="d-flex">
                                            ...
                                            <div class="flex-grow-1 ms-3">
                                                ...
                                                <p class="text-muted small mb-0">Keterlambatan pengembalian akan dikenakan
                                                    denda Rp 1.000,- per hari untuk setiap buku.</p>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="d-flex">
                                            ...
                                            <div class="flex-grow-1 ms-3">
                                                ...
                                                <p class="text-muted small mb-0">Perpanjangan dapat dilakukan 1 kali dengan
                                                    durasi maksimal 7 hari, selama tidak ada antrean peminjaman.</p>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="d-flex">
                                            ...
                                            <div class="flex-grow-1 ms-3">
                                                ...
                                                <p class="text-muted small mb-0">Kerusakan atau kehilangan buku akan
                                                    dikenakan denda sesuai dengan harga buku atau penggantian dengan buku
                                                    yang sama.</p>
                                            </div>
                                        </div>
                                    </div>
                ...
                @role('admin|staff')
                    <div class="card border-0 shadow-sm bg-light mb-4">
                        <div class="card-body p-4">
                            <h5 class="card-title mb-3"><i class="fas fa-clipboard-list me-2"></i>Catatan untuk Staf
                                Perpustakaan</h5>
                            <div class="mb-3">
                            ...
                            <div>
                                ...
                                <textarea class="form-control form-control-sm" rows="2"
                                    placeholder="Tambahkan catatan internal tentang buku ini..."></textarea>
                            </div>
                        </div>
                    </div>
                @endrole
                        ...
                        <div class="modal-body p-4">
                            ...
                            @if (auth()->user()->hasRole('guru'))
                                <div class="mb-3">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="number" class="form-control" name="quantity" id="quantity"
                                            min="1" max="{{ $book->availableStock }}" value="1" required>
                                        <span class="input-group-text">dari {{ $book->availableStock }}</span>
                                    </div>
                                    <div class="form-text">Maksimal peminjaman {{ min(5, $book->availableStock) }} buku untuk
                                        guru.
                                    </div>
                                </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" class="form-control" name="borrowed_for" id="borrowed_for"
                                            required>
                                    </div>
                            ...
                            <div class="alert alert-info d-flex" role="alert">
                                ...
                                <div class="flex-grow-1 ms-3">
                                    ...
                                    <p class="small mb-0">Buku harus dikembalikan tepat waktu untuk menghindari sanksi
                                        keterlambatan. Denda keterlambatan sebesar Rp 1.000,- per hari.</p>
                                </div>
                            </div>
                        </div>
